...
<body>
<div class="container">
    <h3 style="text-align: center;">Tác giả</h3>
    <div>
        <h1 style="text-align: center; color: black; margin-top: 30px; margin-bottom: 60px">Edit dữ liệu bảng tác
            giả</h1>
        <frm:form
                modelAttribute="tacGia"
                action="${pageContext.request.contextPath}/TacGia/create"
                method="POST"
                enctype="multipart/form-data">
            <div class="form-group">
                <frm:hidden path="id" value="${tacGia.id}"/>
            </div>
            <div class="row">
                <div class="col-6">
                    <label style="margin-left: 30px">Tên tác giả: </label>
                    <frm:input path="ten" cssStyle="width: 300px;" placeholder="text" value=""/>
                    <frm:errors path="ten"></frm:errors>
                    <label class="">${checkTGNotNull}</label>
                    <label>${checkTGHopLe}</label>
                </div>
                <div class="col-6">
