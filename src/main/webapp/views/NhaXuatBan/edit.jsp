...
<div class="container">
    ...
    <div>
        ...
        <frm:form
                modelAttribute="nhaXuatBan"
                action="${pageContext.request.contextPath}/NhaXuatBan/create"
                method="POST"
                enctype="multipart/form-data">
            <div class="form-group">
                <frm:hidden path="id" value="${nhaXuatBan.id}"/>
            </div>
            <div class="row">
                <div class="col-6">
                    ...
                    <label class="">${checkNXBNotNull}</label>
                    <label>${checkNXBHopLe}</label>
                </div>
                <div class="col-6">
