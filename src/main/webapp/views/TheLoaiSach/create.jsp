...
<div class="container">
    ...
    <div>
        <h1 style="text-align: center; color: black; margin-top: 30px; margin-bottom: 60px">Thêm dữ liệu bảng nhà xuất bản</h1>
        <frm:form
            ...
            <div class="row">
                <div class="col-6">
                    <label style="margin-left: 30px">Tên nhà xuất bản: </label>
